...
namespace Aufbauwerk.Tools.GroupPolicyInstaller.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Sucht eine lokalisierte Zeichenfolge, die The registry path &apos;{0}\{1}&apos; is missing. ähnelt.
        /// </summary>
        internal static string ProgramRegPathMissing {
            get {
                return ResourceManager.GetString("ProgramRegPathMissing", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Sucht eine lokalisierte Zeichenfolge, die The root of registry path &apos;{0}&apos; is invalid. ähnelt.
        /// </summary>
        internal static string ProgramRegPathRootInvalid {
            get {
                return ResourceManager.GetString("ProgramRegPathRootInvalid", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Sucht eine lokalisierte Zeichenfolge, die The value name &apos;{1}&apos; in &apos;{0}&apos; is not an integer. ähnelt.
        /// </summary>
        internal static string ProgramRegValueNameInvalid {
            get {
                return ResourceManager.GetString("ProgramRegValueNameInvalid", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Sucht eine lokalisierte Zeichenfolge, die The type of value &apos;{1}&apos; in &apos;{0}&apos; is a {2}, not a String or ExpandString. ähnelt.
        /// </summary>
        internal static string ProgramRegValueTypeInvalid {
            get {
                return ResourceManager.GetString("ProgramRegValueTypeInvalid", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Sucht eine lokalisierte Zeichenfolge, die Windows Installer context for task {0} ähnelt.
        /// </summary>
        internal static string TaskMSIContext {
            get {
                return ResourceManager.GetString("TaskMSIContext", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Sucht eine lokalisierte Zeichenfolge, die PowerShell context for task {0} ähnelt.
        /// </summary>
        internal static string TaskPSContext {
            get {
                return ResourceManager.GetString("TaskPSContext", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Sucht eine lokalisierte Zeichenfolge, die Couldn&apos;t remove the registry entry for task {0}: {1} ähnelt.
        /// </summary>
        internal static string TaskRemoveFailed {
            get {
                return ResourceManager.GetString("TaskRemoveFailed", resourceCulture);
            }
        }
